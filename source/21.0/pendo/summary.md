In order to help us make better decisions about future product development, this release incorporates high-level usage telemetry using the industry standard 3rd party service [Pendo](https://pendo.io).
...
* User Name
* User Email Address
* Events from user interactions with Aucerna Execute (page loads, button clicks, etc.)
...
Please get in touch with [Aucerna Execute](mailto:executesupport@aucerna.com) support.